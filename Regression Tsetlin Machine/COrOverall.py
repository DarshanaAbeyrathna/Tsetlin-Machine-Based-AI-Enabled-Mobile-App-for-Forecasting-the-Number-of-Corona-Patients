...
df = np.loadtxt("Overall.txt").astype(dtype=np.float32)
...
save('TMextractsOverall.npy', TMextracts)
save('RegSupOverall.npy', suportive)
save('ThredsOverall.npy', thresholds)
save('LabsOverall.npy', labels)
